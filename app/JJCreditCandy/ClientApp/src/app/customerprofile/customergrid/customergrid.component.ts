...
export class CustomergridComponent implements OnInit {
  ...
  fillFields(row: any) {
    ...
    if(this.inputModel.grupo1.get("tmpservicetrandatechk").value===true)
    {
    this.inputModel.grupo1.get("tmpservicetrandatechk").disable();
    }else{

      this.inputModel.grupo1.get("tmpservicetrandatechk").enable();
    }
