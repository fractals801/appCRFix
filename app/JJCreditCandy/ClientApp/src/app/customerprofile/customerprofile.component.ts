...
export class CustomerprofileComponent implements OnInit, OnDestroy,AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    if(GlobalVariables.ISMOCKUP){
      this.xsection=JSON.parse('{"s1":{"root":{},"grid":{"disable":false},"ch":{"customername":{},"customerlastname":{},"dob":{},"email":{},"phone1":{},"phone2":{},"refereddate":{}}},"s2":{"root":{},"grid":{"disable":false},"ch":{"address1":{},"address2":{},"city":{},"state":{},"zipcode":{},"country":{}}},"s3":{"root":{},"grid":{"disable":false},"ch":{"null":{}}}}'
);
    }else{
    this.uaccess.setUserAccess("customerinfo", this.grupo1, this.xsection);
    }
  }
